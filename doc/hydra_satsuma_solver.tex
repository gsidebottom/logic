...
detects symmetries with dejavu and emits a binary substitution-redundancy
(SR) proof of its breaking clauses, kissat appends its clausal
...
\item \texttt{satsuma fix <cnf> --bsr --proof-file proof.out --out-file sb.cnf}
  --- symmetry detection with dejavu (graph automorphisms of the
  colored literal--clause incidence graph), structure-based
  symmetry-breaking clauses, and a \emph{binary SR proof} justifying
...
\bibitem{sbr} M.~Anders et al.
\newblock Simplify, order, break, repeat (satsuma-iter).
\newblock \emph{SAT}, 2026,
  \url{https://drops.dagstuhl.de/storage/00lipics/lipics-vol377-sat2026/}.
\newblock satsuma: \url{https://github.com/markusa4/satsuma}.
