...
substantially exceeds the competition nodes', so equal nominal
seconds buy more search --- which is why local solve counts (e.g.\
the \texttt{hydra} baseline's 318 of the 391 deduplicated instances)
run well above the official 276/400 despite ten-way contention
working in the opposite direction. The comparisons this note will
