...
All three runs use the identical protocol on all 400 official
benchmarks (the selection's nine duplicate hashes each appear as two
benchmarks and count twice, as in official scoring).
...
solved instance. \texttt{hydra} is aligned to the official benchmarks per
