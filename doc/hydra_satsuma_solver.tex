...
mode, this machine): instances solved (sorted by solve time) against
per-instance time. \texttt{hydra} is projected onto the 400 official
slots per hash. The separation from $\sim$250 instances on is the
