...
All three runs use the identical protocol on all 400 official slots
(the selection's nine duplicate hashes each occupy two slots and
count twice, as in official scoring).
