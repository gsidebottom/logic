...
\midrule
\texttt{hydra} & 318 & --- & --- & 2459 & 179/181$^{\dagger}$ \\
\texttt{hydra\_satsuma} & \textbf{335} & 139 & 196 & \textbf{1988} & 170/196 \\
\texttt{satsuma} & \multicolumn{5}{c}{\emph{running}} \\
\bottomrule
\end{tabular}

{\footnotesize $^{\dagger}$per unique instance (the \texttt{hydra}
run predates the 400-slot protocol; its two unchecked proofs are
checker-resource casualties, not rejections).}
\end{center}
