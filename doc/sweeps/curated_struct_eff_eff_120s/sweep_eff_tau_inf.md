...
| bench_11496.smt2 | UNSAT | 0.0411s |
...
| mod2c-3cage-unsat-10-3.sat05-2568.reshuffled-07 | SAT | 0.0712s |
| urqh1c2x3.shuffled-as.sat03-1458 | UNSAT | 44.1804s |
| 3col80_5_8.shuffled | SAT | 0.775s |
| 3col80_5_5.shuffled | SAT | 0.1282s |
| rope_0001.shuffled | UNSAT | 0.0009s |
| 3col80_5_3.shuffled | SAT | 0.3042s |
...
| Break_04_06.xml | SAT | 0.0154s |
| Break_triple_04_06.xml | SAT | 0.0175s |
| Break_04_08.xml | SAT | 0.0147s |
...
| Break_triple_04_10.xml | SAT | 0.0206s |
| x9-02043.sat.sanitized | SAT | 0.0016s |
| x9-02090.sat.sanitized | SAT | 0.0051s |
| x9-02036.sat.sanitized | UNSAT | 0.0061s |
| x9-02021.sat.sanitized | UNSAT | 0.0055s |
| x9-02042.sat.sanitized | UNSAT | 0.0076s |
| x9-02053.sat.sanitized | UNSAT | 0.0088s |
| x9-02073.sat.sanitized | UNSAT | 0.0071s |
| Break_triple_04_04.xml | SAT | 0.087s |
| Break_unsat_04_03.xml | UNSAT | 0.1261s |
| Break_04_04.xml | SAT | 0.1985s |
| ezfact16_8.shuffled | UNSAT | 0.4454s |
| ezfact16_7.shuffled | UNSAT | 0.7608s |
| ezfact16_5.shuffled | UNSAT | 1.0889s |
| ezfact16_10.shuffled | UNSAT | 2.2318s |
| ph9 | UNSAT | 2.0369s |
| x1_16.shuffled | UNSAT | 0.2035s |
| x2_16.shuffled | UNSAT | 0.2651s |
| ezfact16_6.shuffled | UNSAT | 31.4135s |
| php-010-008.shuffled-as.sat05-1171 | TIMEOUT | 120s |
| x1_24.shuffled | UNSAT | 42.2195s |
