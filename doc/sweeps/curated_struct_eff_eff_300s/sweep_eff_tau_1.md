...
| bench_11496.smt2 | UNSAT | 0.0372s |
| hcb2.shuffled-as.sat03-1430 | UNSAT | 0.0005s |
| urqh1c2x2.shuffled-as.sat03-1457 | UNSAT | 0.0021s |
| marg2x3.shuffled-as.sat03-1441 | UNSAT | 0.0062s |
| fclqcolor-08-06-06.shuffled-as.sat05-1265 | SAT | 0.0029s |
| mod2c-3cage-unsat-10-3.sat05-2568.reshuffled-07 | SAT | 0.0713s |
| urqh1c2x3.shuffled-as.sat03-1458 | UNSAT | 44.4247s |
| 3col80_5_8.shuffled | SAT | 0.7802s |
| 3col80_5_5.shuffled | SAT | 0.1239s |
| rope_0001.shuffled | UNSAT | 0.0009s |
| 3col80_5_3.shuffled | SAT | 0.2905s |
...
| Break_triple_04_06.xml | SAT | 0.0188s |
| Break_04_10.xml | SAT | 0.0164s |
| x9-02007.sat.sanitized | SAT | 0.0018s |
| x9-02023.sat.sanitized | SAT | 0.0053s |
| Break_triple_04_08.xml | SAT | 0.0164s |
| x9-02044.sat.sanitized | SAT | 0.0036s |
| Break_triple_04_10.xml | SAT | 0.0212s |
| x9-02090.sat.sanitized | SAT | 0.0053s |
| x9-02043.sat.sanitized | SAT | 0.0014s |
| x9-02036.sat.sanitized | UNSAT | 0.006s |
| x9-02042.sat.sanitized | UNSAT | 0.0075s |
| x9-02021.sat.sanitized | UNSAT | 0.0056s |
| x9-02053.sat.sanitized | UNSAT | 0.0088s |
| x9-02073.sat.sanitized | UNSAT | 0.0074s |
| Break_triple_04_04.xml | SAT | 0.0899s |
| Break_unsat_04_03.xml | UNSAT | 0.1287s |
| Break_04_04.xml | SAT | 0.2046s |
| ezfact16_8.shuffled | UNSAT | 0.4512s |
| ezfact16_7.shuffled | UNSAT | 0.7458s |
| ezfact16_5.shuffled | UNSAT | 1.0532s |
| ezfact16_10.shuffled | UNSAT | 2.2795s |
| ph9 | UNSAT | 1.9999s |
| x1_16.shuffled | UNSAT | 0.2003s |
| x2_16.shuffled | UNSAT | 0.255s |
| ezfact16_6.shuffled | UNSAT | 31.4918s |
| php-010-008.shuffled-as.sat05-1171 | TIMEOUT | 300s |
| x1_24.shuffled | UNSAT | 40.1922s |
| x2_24.shuffled | UNSAT | 104.6039s |
